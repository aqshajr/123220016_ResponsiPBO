...
public class DAOMahasiswa implements InterfaceDAOMahasiswa { //DAO itu isinya query
    ...
    public void insert(ModelMahasiswa mahasiswa) {
       try {
            ...
            */
            ...
            statement.setString(1, mahasiswa.getNama()); //? ke-1
            statement.setString(2, mahasiswa.getNim()); //? ke-2
